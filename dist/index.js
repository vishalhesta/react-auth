...
var Button = function Button(props) {
  return React__default.createElement(BTN, {
...
var Input = function Input(props) {
  var field = props.field,
    ...
    errors = props.errors;
  return React__default.createElement(TextInput, null, label && React__default.createElement("label", null, label), React__default.createElement("input", Object.assign({
    placeholder: placeholder,
    className: "text-input",
    type: type,
    value: field.value
  }, field)), errors && React__default.createElement(errorMessage.ErrorMessage, {
    errors: errors,
    name: field.name,
...
var apiEffectError = function apiEffectError(props) {
  return reactToastify.toast.error((props === null || props === void 0 ? void 0 : props.message) || "Something went wrong.", _extends({}, options));
};
var apiEffectSuccess = function apiEffectSuccess(props) {
  console.log("Success ===>>>", props.message);
  return reactToastify.toast.success((props === null || props === void 0 ? void 0 : props.message) || "Success!", _extends({}, options));
};
  ...
  return React__default.createElement("div", null, React__default.createElement("form", {
    ...
    return React__default.createElement("div", {
      ...
      render: function render(field) {
        return React__default.createElement(Input, Object.assign({}, field, {
          type: i.type,
    ...
    type: "submit"
  }, React__default.createElement("span", null, isSubmitting ? 'Submitting...' : 'Submit'))), React__default.createElement(reactToastify.ToastContainer, {
    position: "top-right",
    autoClose: 3000,
    hideProgressBar: false,
    newestOnTop: false,
...
exports.ForgotPasswordVerifyOTPForm = ForgotPasswordVerifyOTPForm;
